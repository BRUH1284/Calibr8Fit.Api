...
namespace Calibr8Fit.Api.Migrations
{
    ...
    [Migration("20250808105433_AddActivityRecord")]
    partial class AddActivityRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calibr8Fit.Api.Models.ActivityBase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Calibr8Fit.Api.Models.Activity", b =>
                {
                    b.HasBaseType("Calibr8Fit.Api.Models.ActivityBase");
            ...
            modelBuilder.Entity("Calibr8Fit.Api.Models.ActivityRecord", b =>
                {
                    b.HasOne("Calibr8Fit.Api.Models.ActivityBase", "Activity")
                        .WithMany()
